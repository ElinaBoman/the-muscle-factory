...
## Table of Contents
- [General](https://github.com/ElinaBoman/the-muscle-factory#general)
  - [Table of Contents](https://github.com/ElinaBoman/the-muscle-factory#table-of-contents)
  - [Project Goals](https://github.com/ElinaBoman/the-muscle-factory#project-goals)
- [UX](https://github.com/ElinaBoman/the-muscle-factory#ux)
  - [Development](https://github.com/ElinaBoman/the-muscle-factory#development)
  - [Flowchart](https://github.com/ElinaBoman/the-muscle-factory#flowchart)
  - [User Stories](https://github.com/ElinaBoman/the-muscle-factory#user-stories)
  - [Colors and Fonts](https://github.com/ElinaBoman/the-muscle-factory#colors-and-fonts)
  - [Wireframes](https://github.com/ElinaBoman/the-muscle-factory#wireframes)
- [General Features](https://github.com/ElinaBoman/the-muscle-factory#general-features)
  - [Features](https://github.com/ElinaBoman/the-muscle-factory#features)
- [Database](https://github.com/ElinaBoman/the-muscle-factory#database)
- [Testing](https://github.com/ElinaBoman/the-muscle-factory#testing)
  - [Code Validation](https://github.com/ElinaBoman/the-muscle-factory#code-validation)
  - [Testing User Stories](https://github.com/ElinaBoman/the-muscle-factory#testing-user-stories)
  - [Manual Testing](https://github.com/ElinaBoman/the-muscle-factory/blob/main/docs/readme%20docs/README-TESTING.md)
  - [Lighthouse Testing](https://github.com/ElinaBoman/the-muscle-factory#lighthouse-testing)
  - [Browser Testing](https://github.com/ElinaBoman/the-muscle-factory#browser-testing)
- [Future Improvements](https://github.com/ElinaBoman/the-muscle-factory#future-improvements)
- [Bugs](https://github.com/ElinaBoman/the-muscle-factory#bugs)
- [Technologies Used](https://github.com/ElinaBoman/the-muscle-factory#technologies-used)
  - [Libraries](https://github.com/ElinaBoman/the-muscle-factory#libraries)
    - [Packages](https://github.com/ElinaBoman/the-muscle-factory#packages)
  - [Framework and Websites](https://github.com/ElinaBoman/the-muscle-factory#framework-and-websites)
- [Deployment](https://github.com/ElinaBoman/the-muscle-factory#deployment)
- [Credits](https://github.com/ElinaBoman/the-muscle-factory#credits)
